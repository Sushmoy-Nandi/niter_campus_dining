  ...
  return (
    <header className="sticky top-0 z-50 flex h-14 items-center gap-4 border-b bg-background/80 px-4 backdrop-blur-md">
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="outline-none border-none bg-transparent p-0 m-0 relative h-8 w-8 cursor-pointer rounded-full ring-2 ring-primary/20 transition-shadow hover:ring-primary/40">
